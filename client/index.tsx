                ...
                <div className="mx-auto max-w-lg">
                  {!auth.isLoading && !auth.isGuest && (
                    <div className="flex justify-end mb-4">
                      <button
                        className="flex items-center gap-3 text-sm text-neutral-400 hover:text-white transition-colors cursor-pointer p-2 rounded-xl hover:bg-neutral-900/60"
                        onClick={() => signOut()}
                      >
                        <div className="flex flex-col items-end">
                          {auth.displayName && <span className="text-white text-sm">{auth.displayName}</span>}
                          <span className="text-neutral-400 text-xs">Click to log out</span>
                        </div>
                        {auth.picture ? (
                          <img
                            src={auth.picture}
                          ...
                          <svg
                            ...
                            className="px-1 bg-neutral-800 rounded-full size-8"
                          >
